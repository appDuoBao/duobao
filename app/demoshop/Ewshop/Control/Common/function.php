        ...
        foreach($links as $link){
            ...
            if(preg_match('/^\[([a-z_]+)\]$/',$href,$matches)){
                ...
                $href   =   str_replace(
                    ...
                    array('del?ids='.$data['id'].'&model='.$model['id'],
                    'edit?id='.$data['id'].'&model='.$model['id'],
                    'index?pid='.$data['id'].'&model='.$model['id']),
                    $href);
                ...
                $href   =   str_replace(
                    array('[DELETE]','[EDIT]','[LIST]'),
                    array('del?ids='.$data['id'].'&model='.$model['id'].'',
                    'edit?id='.$data['id'].'&model='.$model['id'].'&cate_id=[category_id]',
                    'index?pid='.$data['id'].'&model='.$model['id'].'&cate_id=[category_id]'),
                    $href);
				**/
