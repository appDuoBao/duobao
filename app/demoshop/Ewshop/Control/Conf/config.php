...
return array(
    ...
    'DOWNLOAD_UPLOAD' => array(
        ...
        'exts'     => 'jpg,gif,png,jpeg,zip,rar,tar,gz,7z,doc,docx,txt,xml,flv', //允许上传的文件后缀
    ...
    /* SESSION 和 COOKIE 配置 */
    'SESSION_PREFIX' => 'ewtp_admin', //session前缀
    'COOKIE_PREFIX'  => 'ewtp_admin_', // Cookie前缀 避免冲突
