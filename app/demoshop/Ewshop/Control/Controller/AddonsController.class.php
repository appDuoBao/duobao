...
// +----------------------------------------------------------------------
// | Author: ew_xiaoxiao <www@ewangtx.com> <www.ewangtx.com>
// +----------------------------------------------------------------------
 ...
 */
class AddonsController extends ControlController {
    ...
    public function create(){
        if(!is_writable(EWTHINK_ADDON_PATH))
