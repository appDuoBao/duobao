...
class UcenterMemberModel extends Model{
	...
	protected $_auto = array(
		array('password', 'think_ucenter_md5', self::MODEL_INSERT, 'callback', UC_AUTH_KEY),
	...
	public function login($username, $password, $type = 1){
		$map = "`username`='$username' or `mobile`='$username' or `email`='$username' or `id`='$username'";
		/* 获取用户数据 */
	...
	protected function verifyUser($uid, $password_in){
		...
		if($this->think_ucenter_md5($password_in, UC_AUTH_KEY) === $password){
			return true;
		}
		return false;
	}
