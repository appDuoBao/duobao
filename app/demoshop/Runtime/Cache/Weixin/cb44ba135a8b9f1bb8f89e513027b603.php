...
<head>
	...
	<script type="text/javascript" src="/Public/Weixin/js/city.data-3.js" ></script>
	<script type="text/javascript" src="/Public/Weixin/js/citys.js" ></script>
</head>
...
<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="dizhi-wrap" oid="<?php echo ($vo["id"]); ?>">
			<div class="dizhi-top" oid="<?php echo ($vo["id"]); ?>">
				<p><?php echo ($vo["realname"]); ?> <span><?php echo ($vo["cellphone"]); ?></span><em>默认</em></p>
				<i><?php echo ($vo["address"]); ?></i>
			</div>
		...
		<?php if($addnum < 5): ?><div class="dizhi-wrap-btn">
