...
<div id="main-content">
  ...
  <div id="main" class="main">
	...
	<div class="main-title">
		...
		<h2><?php echo isset($info['id'])?'编辑':'新增';?>单页</h2>
				...
				<div id="tab1" class="tab-pane in tab1">
					...
					<div class="form-item">
						...
						<label class="item-label">
							...
							详细内容<span class="check-tips"></span>
...
-->
			<!--		<div class="form-item">
						...
						<div class="controls">
							...
							<?php $_result=get_article_model();if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><label class="checkbox">
...
<div class="form-item">
			...
			<!--		<div class="form-item">
				...
				<div class="form-item">
					<input type="hidden" name="ismenu"  value="2"><!--默认为单页类型-->
                    
                    <input type="hidden" name="allow_publish"  value="2"><!--默认为允许前后台发布-->
...
<script type="text/javascript">
	...
	<script type="text/javascript">
		...
		//导航高亮
		highlight_subnav('<?php echo U('Page/index');?>');
