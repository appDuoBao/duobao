...
<div id="main-content">
  ...
  <div id="main" class="main">
	...
	<form action="<?php echo U();?>" method="post" class="form-horizontal">
		...
		<div class="form-item">
			<label class="item-label">url<span class="check-tips">（填写至微信平台服务器配置）</span></label>
			<div class="controls">
				<?php echo ($info["url"]); ?>
			</div>
		</div>
		<div class="form-item">
			<label class="item-label">token<span class="check-tips">（可自定义设置，填写至微信平台服务器配置）</span></label>
			<div class="controls">
		...
		<div class="form-item">
			<label class="item-label">appSecret<span class="check-tips"></span></label>
			<div class="controls">
			...
			<div class="form-item">
			<label class="item-label">mchid<span class="check-tips">(微信支付商户号)</span></label>
			<div class="controls">
				<input type="text" class="text input-large" name="mchid" value="<?php echo ((isset($info["mchid"]) && ($info["mchid"] !== ""))?($info["mchid"]):''); ?>">
			</div>
		</div>
			<div class="form-item">
			<label class="item-label">key<span class="check-tips">(API密钥)</span></label>
			<div class="controls">
		...
		<div class="form-item">
			<label class="item-label">授权回调页面域名<span class="check-tips">(不带http://如：www.xxxx.com;与微信平台授权回调页面域名一致，一般情况不做修改)</span></label>
			<div class="controls">
