	...
	<div class="cf">
        ...
        <div class="search-form fr cf">
            ...
            <div class="sleft">
                ...
                <input type="text" name="title" class="search-input" value="<?php echo I('title');?>" placeholder="请输入商品类型名称">

                <a class="sch-btn" href="javascript:;" id="search" url="/index.php?s=/Control/GoodsType/index.html"><i class="btn-search"></i></a>
		 ...
		 <table>
			...
			<tbody>
				...
				<?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
					...
					<td><input class="ids row-selected" type="checkbox" name="id[]" value="<?php echo ($vo["type_id"]); ?>"></td>

						<td><?php echo ($vo["type_id"]); ?></td>

						<td><a title="编辑" href="<?php echo U('edit?id='.$vo['type_id']);?>"><?php echo ($vo["type_name"]); ?></a></td>

                        <td><?php echo (date('Y-m-d H:i:s',$vo["create_time"])); ?></td>
                        <td>
                        <a title="广告管理" href="<?php echo U('/Control/GoodsExtend/index?adp='.$vo['type_id']);?>">属性列表</a>
                        <a title="编辑" href="<?php echo U('edit?id='.$vo['type_id']);?>">编辑</a>
                        <a class="confirm ajax-get" title="删除" href="<?php echo U('del?id='.$vo['type_id']);?>">删除</a>
                        </td>
