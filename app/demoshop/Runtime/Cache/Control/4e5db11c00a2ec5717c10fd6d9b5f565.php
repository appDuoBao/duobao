  ...
  <div id="main" class="main">
	...
	<div class="cf">
		...
		<div class="fl">
			...
			<button class="btn ajax-post" target-form="ids" hide-data="true" url="<?php echo U("goods/paste");?>">粘 贴</button>
            ...
            <button class="btn document_add" url='<?php echo U("goods/import");?>'>导入</button>
