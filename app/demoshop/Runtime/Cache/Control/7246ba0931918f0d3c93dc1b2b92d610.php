	...
	<div class="cf">
        ...
        <div class="search-form fr cf">
            ...
            <div class="sleft">
                ...
                <input type="text" name="name" class="search-input" value="<?php echo I('name');?>" placeholder="请输入大转盘名称">

                <a class="sch-btn" href="javascript:;" id="search" url="/index.php?s=/Control/PromotionDzp/index.html"><i class="btn-search"></i></a>
			...
			<tbody>
				...
				<?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
					...
					<td><input class="ids row-selected" type="checkbox" name="id[]" value="<?php echo ($vo["id"]); ?>"></td>
						<td><a title="编辑" href="<?php echo U('edit?id='.$vo['id']);?>"><?php echo ($vo["name"]); ?></a></td>
                        <td><?php echo ($vo["start_time"]); ?></td>
                        <td><?php echo ($vo["end_time"]); ?></td>
						<td><?php echo ($vo["status_text"]); ?></td>
						<td>
                            <a title="奖品数据" href="<?php echo U('prize_list?id='.$vo['id']);?>">奖品</a>
                            <a title="抽奖数据" href="<?php echo U('data_list?id='.$vo['id']);?>">数据</a>
