	...
	<div class="cf">
        ...
        <div class="search-form fr cf">
            ...
            <div class="sleft">
                ...
                <input type="text" name="name" class="search-input" value="<?php echo I('name');?>" placeholder="请输入优惠券名称">

                <a class="sch-btn" href="javascript:;" id="search" url="/index.php?s=/Control/PromotionYhj/index.html"><i class="btn-search"></i></a>
	...
	<div class="data-table table-striped">
		 ...
		 <table>
			...
			<tbody>
				...
				<?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$pyhj): $mod = ($i % 2 );++$i;?><tr>

					<td><input class="ids row-selected" type="checkbox" name="id[]" value="<?php echo ($pyhj["id"]); ?>"></td>

						<!--<td><?php echo ($pyhj["id"]); ?></td>-->

						<td><a title="编辑" href="<?php echo U('edit?id='.$pyhj['id']);?>"><?php echo ($pyhj["name"]); ?></a></td>

						<!--<td><?php if($pyhj['type']==1): ?>按用户发放<?php elseif($pyhj['type']==2): ?>线下发放<?php endif; ?></td>-->
                        <td><?php echo ($pyhj["price"]); ?></td>
						<td><?php echo ($pyhj["min_price"]); ?></td>
                        <td><?php echo ($pyhj["start_time"]); ?></td>
                        <td><?php echo ($pyhj["end_time"]); ?></td>

						<td>
                            <a title="发放" href="<?php echo U('send?id='.$pyhj['id']);?>">发放</a>
                            <a title="查看" href="<?php echo U('view?id='.$pyhj['id']);?>">查看</a>
                            <a title="编辑" href="<?php echo U('edit?id='.$pyhj['id']);?>">编辑</a>
                            <a class="confirm ajax-get" title="删除" href="<?php echo U('del?id='.$pyhj['id']);?>">删除</a>
                        </td>
