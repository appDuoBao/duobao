  ...
  <div id="main" class="main">
    ...
    <tbody>
		<?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
			...
			<td>
				<a href="<?php echo U('User/address?uid='.$vo['uid']);?>" class="authorize" title="收货地址" alt="收货地址">地址</a>
				<a href="<?php echo U('User/account?uid='.$vo['uid']);?>" class="authorize" title="资金明细" alt="资金明细">资金</a>
                <a href="<?php echo U('User/loginhistory?uid='.$vo['uid']);?>" class="authorize" title="登录记录" alt="登录记录">登录记录</a>
            </td>            
			<td>
