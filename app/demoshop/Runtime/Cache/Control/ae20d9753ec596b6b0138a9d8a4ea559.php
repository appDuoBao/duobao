...
<head>
<meta charset="UTF-8">
<title>欢迎您登录一网电商</title>
<link rel="stylesheet" type="text/css" href="/Public/Control/css/login.css" media="all">
    ...
    <div class="login-main pr">
      <form action="<?php echo U('login');?>" method="post" class="login-form">
        ...
        <div id="itemBox" class="item-box">
          ...
          <div class="item b1"> <i class="icon-login-verifycode"></i>
            <input type="text" name="verify" id="verify" class="reloadverify" placeholder="请填写验证码" autocomplete="off"/>
          </div>
          <span class="placeholder_copy placeholder_check">请填写验证码</span> 
          <img id="verifyimg" class="verifyimg" src='<?php echo U("Public/verify");?>' onclick="javascript:changecode();"  width="288" height="50"/> 
       </div>         
