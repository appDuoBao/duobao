...
<div id="main-content">
  ...
  <div id="main" class="main">
	...
	<div class="main-title">
		...
		<h2><?php echo isset($info['id'])?'编辑':'新增';?>优惠券</h2>
				...
				<div id="tab1" class="tab-pane in tab1">
					...
					<div class="form-item">
						<label class="item-label">
							优惠券名称<span class="check-tips">（名称不能为空）</span>
						</label>
						<div class="controls">
 					...
 					<!--<div class="form-item">
						<label class="item-label">
							发放类型<span class="check-tips"></span>
						</label>
                        <div class="controls">
                            <select name="type" id="type">
                                <option value="1" <?php if($info['type']==1): ?>selected<?php endif; ?> >按用户发放</option>
								<option value="2" <?php if($info['type']==2): ?>selected<?php endif; ?> >线下发放</option>
                            </select>                          
                        </div>
					</div>-->
					<input type="hidden" name="type" value="1">
 					<div class="form-item">
						<label class="item-label">
							优惠券金额<span class="check-tips"></span>
						</label>
						<div class="controls">
							<input type="text" name="price" class="text input-large" value="<?php echo ((isset($info["price"]) && ($info["price"] !== ""))?($info["price"]):''); ?>">
						</div>
					</div>  
					<div class="form-item">
						<label class="item-label">
							最小订单金额<span class="check-tips">（只有商品总金额达到这个数的订单才能使用这种优惠券）</span>
						</label>
						<div class="controls">
							<input type="text" name="min_price" class="text input-large" value="<?php echo ((isset($info["min_price"]) && ($info["min_price"] !== ""))?($info["min_price"]):''); ?>">
						</div>
					</div>                                   
					<div class="form-item">
						<label class="item-label">
...
$(function(){
    ...
    $('.time').datetimepicker({
		...
		highlight_subnav('<?php echo U('PromotionYhj/index');?>');
