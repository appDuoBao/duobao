    ...
    $('.ajax-post').click(function(){
        ...
        if( ($(this).attr('type')=='submit') || (target = $(this).attr('href')) || (target = $(this).attr('url')) ){
            ...
            if($(".tj-box").length > 0){
            	...
            	$(".tj-box .tj").each(function(){
            		
            		var datas = {};
            		
            		datas.kucun = $("input[name='kucun']",this).val();
            		datas.jiage = $("input[name='jiage']",this).val();
            		...
            		$("select",this).each(function(){
            			...
            			shuxing.key = $(this).attr("name");
            			shuxing.val = $(this).val();

            			datas.shuxing.push(shuxing);
            	...
            	query += "&tjData=" + JSON.stringify(tjData);
