        ...
        <ul>
            ...
            <?php if(is_array($data["code_list"])): $i = 0; $__LIST__ = $data["code_list"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><!--
                ...
                <li>
                    ...
                    <div class="li2" style="font-size:10px">
                    <?php echo ($vo["code"]); ?>
                    </div>

                    <div class="li3"><p <?php if($vo['code_56_type'] == '大'): ?>style="background:#ca5757"<?php else: ?>style="background:#e48219"<?php endif; ?> ><?php echo ($vo["code_56"]); ?>&nbsp;&nbsp;<?php echo ($vo["code_56_type"]); ?></p></div>

                    <div class="li3 li4"><p <?php if($vo['code_110_type'] == '大'): ?>style="background:#ca5757"<?php else: ?>style="background:#e48219"<?php endif; ?>><?php echo ($vo["code_110"]); ?>&nbsp;&nbsp;<?php echo ($vo["code_110_type"]); ?></p></div>
