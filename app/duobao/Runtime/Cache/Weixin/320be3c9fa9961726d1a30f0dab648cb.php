...
<head>
    ...
    <link rel="stylesheet" href="/Public/Weixin/css/common.css?t=123">
...
<div class="mainall">
    ...
    <div class="tab-con">
        <ul class="lis"  >
	        <?php if(is_array($data["buy_list"])): $i = 0; $__LIST__ = $data["buy_list"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo1): $mod = ($i % 2 );++$i;?><a href="<?php echo U('My/buyLog?uid='.$vo1['userinfo']['uid']);?>"> <li>
	                <div class="lf">
	                    <img src="<?php echo ($vo1["userinfo"]["headimgurl"]); ?>" alt="">
	                </div>
	                <div class="lm">
	                	<div class="lm-head">
	                		<p class="lmh" style="text-overflow: ellipsis;width: 2.8rem;"><?php echo ($vo1["userinfo"]["nickname"]); ?></p>
	                		 <p class="lmt"><?php echo (date('Y/m/d H:i:s',$vo1["buy_time"])); ?></p>
	                	</div>
	                    <p class="lm-gwk"><?php echo ($vo1["goods_title"]); ?>  购买第<?php echo ($vo1["period"]); ?>期<?php echo ($vo1["buy_num"]); ?>单<?php echo ($vo1["type"]); ?></p>
	                </div>
	                <!--<div class="lt">
	    ...
	    <ul class="lis" style="display:none">
	        <?php if(is_array($data["pk_list"])): $i = 0; $__LIST__ = $data["pk_list"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="<?php echo U('My/buyLog?uid='.$vo['userinfo']['uid']);?>"><li>
	                <div class="lf">
	                ...
	                <div class="lm">
	                    ...
	                    <p class="lm-gwk"><?php echo ($vo["goods_title"]); ?>  中奖第<?php echo ($vo["period"]); ?>期<?php echo ($vo["buy_num"]); ?>单<?php echo ($vo["codeid"]); ?>;</p>
...
<div class="footer">
    ...
    <div class="f3">
        <a href="<?php echo U('Index/topsort');?>">
            <img src="/Public/Weixin/images/top.png" alt="" />
            <p>排行榜</p>
        </a>
    </div>
