...
<head>
    ...
    <link rel="stylesheet" href="/Public/Weixin/css/chanpin.css?t=123">
    <link rel="stylesheet" href="/Public/Weixin/css/chanpinbuy.css?t=12345">
    ...
    //
      function callpay(ptype){
        ...
        $.ajax({
            ...
            data: {total_fee:total_fee,type:type,num:num,goods_type:goods_type,lottery_time:lottery_time,goods_id:goods_id,ptype:2,buyer_id:buyer_id,buyer_logon_id:buyer_id,buyer_id:''},
            dataType: "json",
