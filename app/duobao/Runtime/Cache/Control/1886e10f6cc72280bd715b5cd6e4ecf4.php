...
<div id="main-content">
  ...
  <div id="main" class="main">
    ...
    <div class="main-title">
        <h2>订单列表|订单金额<?php echo ($allprice); ?>元|中奖总金额<?php echo ($allzprice); ?>元|已兑换金额<?php echo ($dhprice); ?>元|未兑换金额<?php echo ($wdhprice); ?>元</h2>
    </div>
    <div class="cf">
        <div class="fl">
    ...
    <div class="data-table table-striped">
        <table class="">
            ...
            <tr>
                ...
                <th class="">是否中奖</th>
                <th class="">是否兑换</th>
                <?php if(($groupid) == "7"): ?><th class="">佣金</th><?php endif; ?>
                <th class="">操作</th>
            </tr>
            </thead>
            <tbody>
            <?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td><a href="<?php echo U('/Control/Bidding/index?uid='.$vo['uid']);?>"><?php echo ($vo["nickname"]); ?></a></td>
                        <td><?php echo ($vo["goods_title"]); ?></td>
                        <td><?php echo ($vo["lottery_time"]); ?></td>
                        <td><?php echo ($vo["period"]); ?></td>
                        <td><?php echo ($vo["code"]); ?></td>
                        <td>
                        28元：<?php echo ($vo["xkjnum"]); ?></br>
                        55元：<?php echo ($vo["dkjnum"]); ?>
                        </td>
                        <td>
                        28元：<?php if($vo['xkjdx'] == 1): ?>小<?php elseif($vo['xkjdx'] == 2): ?>大<?php endif; ?></br>
                        55元：<?php if($vo['dkjdx'] == 1): ?>小<?php elseif($vo['dkjdx'] == 2): ?>大<?php endif; ?>
                        </td>
                        <td><span><?php echo (date('Y/m/d H:i:s',$vo["create_time"])); ?></span></td>
                        <td><?php echo ($vo["money"]); ?></td>
                        <td><?php echo ($vo["num"]); ?></td>
                        <td><?php if($vo['type'] == 1): ?>小<?php elseif($vo['type'] == 2): ?>大<?php endif; ?></td>
                        <td><?php echo ($vo["iszhong"]); ?></td>
						<td><?php echo ($vo["is_exchange"]); ?></td>                        
                        <?php if(($groupid) == "7"): ?><td><?php echo ($vo["commission"]); ?></td><?php endif; ?>
                        <td>
