...
<div id="main-content">
  ...
  <div id="main" class="main">
    ...
    <div class="main-title">
        <h2>未处理兑换|未兑换金额<?php echo ($wdhprice); ?>元</h2>
    </div>
    <div class="cf">
        <div class="fl">
        ...
        <div class="search-form fr cf">
            ...
            <a href="javascript:;" id="search" url="<?php echo U('noexchange');?>" class="btn sch-btn">搜索</a>
        </div>
    </div>
    <!-- 数据列表 -->
    <div class="data-table table-striped">
        <table class="">
            ...
            <?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td><a href="<?php echo U('/Control/Bidding/noexchange?nickname='.$vo['nickname']);?>"><?php echo ($vo["nickname"]); ?></a></td>
...
<script type="text/javascript">
    ...
    <script type="text/javascript">
        ...
        //导航高亮
        highlight_subnav("<?php echo U('Bidding/noexchange');?>");
    </script>
