...
<div id="main-content">
  ...
  <div id="main" class="main">
    ...
    <div class="main-title">
        <h2>兑换列表|中奖总金额<?php echo ($allprice); ?>元|已兑换金额<?php echo ($dhprice); ?>元</h2>
    </div>
    <div class="cf">
        <div class="fl">
        ...
        <div class="search-form fr cf">
            <div class="sleft">
                <input type="text" name="exchange_number" value="<?php echo I('exchange_number');?>" class="search-input" placeholder="请输入兑换码" />&nbsp;&nbsp;
            </div>
            <div class="sleft">
            ...
            <a href="javascript:;" id="search" url="<?php echo U('exchange');?>" class="btn sch-btn">搜索</a>
        </div>
    </div>
    <!-- 数据列表 -->
    <div class="data-table table-striped">
        <table class="">
            ...
            <?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td><a href="<?php echo U('/Control/Bidding/exchange?nickname='.$vo['nickname']);?>"><?php echo ($vo["nickname"]); ?></a></td>
                        <td><?php echo ($vo["goods_title"]); ?></td>
                        <td><?php echo ($vo["orderinfo"]["lottery_time"]); ?></td>
                        <td><span><?php echo (date('Y/m/d H:i:s',$vo["buy_time"])); ?></span></td>
                        <td><?php echo ($vo["allprice"]); ?>元</td>
                        <td><?php if($vo['orderinfo']['type'] != 1): ?>大<?php else: ?>小<?php endif; ?></td>
                        <td><?php echo ($vo["is_exchange_val"]); ?></td>
                        <td><?php echo ($vo["exchange_number"]); ?></td>
                        <td><?php echo ($vo["remarks"]); ?></td>
                        <td>
                            <?php if($vo['is_exchange'] == 1): ?><a href="javascript:;">---</a>
                                <?php else: ?>
                                <a href="<?php echo U('setExchanged?id='.$vo['id']);?>">设置已兑换</a><?php endif; ?>
                            <a  href="<?php echo U('bidding_log?order_number='.$vo['orderinfo']['order_number']);?>">查看</a>
                            <a  href="<?php echo U('addRemarks?id='.$vo['id']);?>">添加备注</a>
                        </td>
...
<script type="text/javascript">
    ...
    <script type="text/javascript">
        ...
        //导航高亮
        highlight_subnav("<?php echo U('Bidding/exchange');?>");
    </script>
