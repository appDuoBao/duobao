...
<head>
	...
	<link rel="stylesheet" href="/Public/Pay/css/homePage.css">
	<link rel="stylesheet" href="/Public/Pay/css/homePage2.css">
		...
		<form role="form" action="/pay.php?s=/user/register.html" method="post" id="formUser">
			...
			<div class="main">
				<div class="tel">
					...
					<img src="/Public/Pay/images/phone_03.jpg" alt="" class="phone">
					<span class="check_tips error_tip" id="dmobile"></span>

				</div>
				<div class="message">
					<input type="text" name="miss" id="miss" oninput="checkphone();" placeholder="验证码">
					<img src="/Public/Pay/images/phone2_03.jpg" alt="" class="mm">
